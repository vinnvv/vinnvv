...
- 💻 **Fullstack Developer** focusing on frontend, backend, and API integration.
- 🧠 Exploring **AI tools, Local LLMs (Ollama), Machine Learning, and Automation workflows**.
- 🎮 **Minecraft Server Owner & Developer**, specializing in RPG/survival systems and custom resource packs.
- 📡 Experienced in internet networking, infrastructure, and field installation.
- ⚙️ Deep interest in AI-assisted coding, model fine-tuning, and scalable deployments.
...
- 🔭 **Building:** Modern fullstack apps (HTML, CSS, JS, Node, Python) with dashboard UIs and backend logic.
- 🌱 **Learning:** Scalable deployment workflows, cloud setups, and AI model integrations.
- 🛠️ **Developing:** Advanced Minecraft RPG server features (Paper, MythicMobs, MMOItems, Vault).
- ⚙️ **Automating:** Discord webhook integrations, Google Sheets data collectors, and AI coding pipelines.
